...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
		...
		private static const SPECIAL_BUTTONS_NUMBER:int = 4;
		private static const SPECIAL_BUTTONS_SIZE:int = 36;
        ...
        public function StatsDisplay()
        {
			...
			mBackground = new Quad(1024-(SPECIAL_BUTTONS_SIZE*SPECIAL_BUTTONS_NUMBER), SPECIAL_BUTTONS_SIZE, 0x0);
			mTextField = new TextField(1024-(SPECIAL_BUTTONS_SIZE*SPECIAL_BUTTONS_NUMBER), SPECIAL_BUTTONS_SIZE, "", BitmapFont.MINI, BitmapFont.NATIVE_SIZE, 0xffffff);
            mTextField.x = 2;
